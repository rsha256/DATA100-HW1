% By Rahul Shah
% Last Updated: Jun 22 2021, 14:08
...
\end{center}
   ...
   \newpage
    ...
    \textbf{
        ...
        \item (2 points) Consider the function $f(c) = \frac{1}{n}\sum_{i=1}^n (x_i - c)^2$. In this scenario, suppose that our data points $x_1, x_2, \ldots, x_n$ are fixed, and that $c$ is the only variable.
